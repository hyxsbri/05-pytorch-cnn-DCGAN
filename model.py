...
class DCGAN(nn.Module):
    def __int__(self, in_channels, out_channels, nker=64, norm="bnorm"):
...
class Discriminator(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm="bnorm"):
        ...
        self.enc2 = CBR2d(1*in_channels, 2*nker, kernel_size=4, stride=2,
                          padding=1, norm=norm, relu=0.2, bias=False)

        self.enc3 = CBR2d(2*in_channels, 4*nker, kernel_size=4, stride=2,
                          padding=1, norm=norm, relu=0.2, bias=False)

        self.enc4 = CBR2d(4*in_channels,8 *nker, kernel_size=4, stride=2,
                          padding=1, norm=norm, relu=0.2, bias=False)
